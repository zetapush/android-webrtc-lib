...
/**
 *
 */@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = As.PROPERTY, property = "__class", defaultImpl = com.zetapush.core.room.sendRoomMessageToMemberInput$Impl.class)
@JsonSubTypes({
	@Type(value = com.zetapush.core.room.sendRoomMessageToMemberInput$Impl.class, name = "com.zetapush.core.room.sendRoomMessageToMemberInput") })
public interface sendRoomMessageToMemberInput {
